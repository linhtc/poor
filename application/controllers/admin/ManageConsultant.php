 ...
 *
 */
class ManageConsultant extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->numRows = 10;
        $this->consultantModel = 'e_consultants';
        $this->viewPath = 'admin/consultant/';
    }
    ...
    public function delete() {
        ...
        if(!empty($id)){
            ...
            $result = $this->db->where('id', $id)->update($this->consultantModel, $pullClass);
            echo $result; exit;
        }
        echo 0; exit;
    }
    ...
    public function data() {
        ...
        $query = "select `id`, `modified`, `ipaddress`, `title`, `summary`, `image`, `content` from ".$this->consultantModel;
        $query .= $this->criteria();
    ...
    private function modify(){
    	...
    	if(!empty($title)){
            ...
            $query = "
                INSERT INTO `".$this->consultantModel."` (".(!empty($id) ? '`id`, ' : '')."`created`, `modified`, `ipaddress`, `title`, `image`, 
