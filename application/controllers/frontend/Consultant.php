...
class Consultant extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->viewPath = 'frontend/consultant/';
    ...
    public function view($new='') {
    	...
    	if(empty($new)){
    		...
    		->from($this->consultantModel)->where('deleted', 0)
    		...
    		$breadcrumb = array(
    				array(
    						...
    						'url' => base_url().'tu-van-mua-sach',
    						'class' => ''
    				),
    				array(
    						'title' => $item->title,
    						'url' => base_url().'tu-van-mua-sach/'.$new,
    						'class' => 'active'
    				)
    		);
    		$data['breadcrumb'] = $breadcrumb;
