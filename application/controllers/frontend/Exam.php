...
class Exam extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->viewPath = 'frontend/exam/';
        $this->subjectModel = 'e_subjects';
        $this->documentModel = 'e_exams';
        $this->docDetailModel = 'e_exam_details';
    	...
    	if(!empty($class) && !empty($subject) && !empty($subclass)){
    		...
    		$breadcrumb = array(
    				...
    				array(
    						...
    						'url' => base_url().'de-thi/'.$parentSubject->friendly,
    						'class' => ''
    				),
    				array(
    						'title' => $class->class,
    						'url' => base_url().'de-thi/'.$parentSubject->friendly.'/'.$class->friendly,
    						'class' => ''
    				),
    				array(
    						'title' => $subject->subject,
    						'url' => base_url().'de-thi/'.$parentSubject->friendly.'/'.$class->friendly.'/'.$subject->friendly,
    						'class' => 'active'
    				),
    		);
    		...
    		$breadcrumb = array(
    				...
    				array(
    						'title' => $subject->subject,
    						'url' => base_url().'de-thi/'.$subject->friendly,
    						'class' => ''
    				),
    		);
    		...
    		if(!empty($subarrayStr)){
    			...
    			$subcrumb = array(
    					'title' => $class->class,
    					'url' => base_url().'de-thi/'.$subject->friendly.'/'.$class->friendly,
    					'class' => 'active'
    			);
