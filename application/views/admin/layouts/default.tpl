...
<html>
    <head>
        ...
        <!-- Theme style -->
        <link href="{base_url()}static/default/admin/template/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
        <!-- AdminLTE Skins. Choose a skin from the css/skins folder instead of downloading all of them to reduce the load. -->
        <link href="{base_url()}static/default/admin/template/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class="skin-blue fixed sidebar-mini">
        ...
        <!-- AdminLTE App -->
        <script src="{base_url()}static/default/admin/template/js/app.min.js" type="text/javascript"></script>

        <!-- SlimScroll 1.3.0 -->
        <script src="{base_url()}static/default/admin/template/plugins/slimScroll/jquery.slimscroll.min.js" type="text/javascript"></script>

        <!-- Select 2 -->
        <script src="{base_url()}static/default/template/select2/js/select2.min.js" type="text/javascript"></script>

        <!-- AdminLTE for demo purposes -->
        <script src="{base_url()}static/default/admin/template/js/demo.js" type="text/javascript"></script>
