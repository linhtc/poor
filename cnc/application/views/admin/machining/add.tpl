                    ...
                    <div class="col-md-6">
                        <form>
                            <div class="form-group">
                                ...
                                <input id="photo" onclick="changePhoto();" type="text" class="form-control params" notnull value="" readonly style="cursor:pointer;" placeholder="Click vào để thay đổi ảnh" >
                            </div>
...
<script>
    ...
    function funcCancel() {
        window.location = '{base_url()}admin/manage-machining/view';
    }
    ...
    $(document).ready(function() {
        ...
        $("#src_photo").change(function (e) {
            ...
            $.ajax({
                url: '{base_url()}admin/manage-machining/photo',
                type: 'POST',
                data: formData,
                dataType: 'JSON',
                success: function (res) {
                    toastr.remove();
                    if(res.result){
                        toastr.success('Tải lên thành công!', langNotify);
                        console.log(res);
                        /*setTimeout(function(){ location.reload(); }, 1000);*/
                        $('#photo').val(res.url);
                    } else{
                        toastr.warning('Tải lên chưa được!', langNotify);
                    }
