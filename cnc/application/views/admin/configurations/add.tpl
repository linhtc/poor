                    ...
                    <div class="col-md-6">
                        <form>
                            <div class="form-group">
                                <label>Quyền</label>
                                <select id="campaign" class="form-control selectpicker params" notnull>
                                    {foreach from=$campaignList key=i item=item}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control params" id="apply_name" notnull >
                            </div>
                            <div class="form-group">
                                <label for="apply_key">Key</label>
                                <input type="text" class="form-control params" id="apply_key" notnull >
                            </div>
                            <div class="form-group">
                                <label for="apply_value">Giá trị</label>
                                <input type="text" class="form-control params" id="apply_value" notnull >
                            </div>
