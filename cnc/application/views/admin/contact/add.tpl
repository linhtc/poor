                    ...
                    <div class="col-md-6">
                        <form>
                            <div class="form-group">
                                <label for="brand">{lang('company')} (*)</label>
                                <input id="company" type="text" class="form-control params" notnull value="" >
                            </div>
                            
                            <div class="form-group">
                                <label for="brand">{lang('address')} (*)</label>
                                <input id="address" type="text" class="form-control params" notnull value="" >
                            </div>

                            <div class="form-group">
                                <label for="brand">{lang('phone')} (*)</label>
                                <input id="phone" type="text" class="form-control params" notnull value="" >
                            </div>

                            <div class="form-group">
                                <label for="brand">{lang('fax')}</label>
                                <input id="fax" type="text" class="form-control params" value="" >
                            </div>

                            <div class="form-group">
                                <label for="brand">{lang('email')} (*)</label>
                                <input id="email" type="text" class="form-control params" notnull value="" >
                            </div>

                            <div class="form-group">
                                <label for="brand">{lang('embed')} (*)</label>
                                <input id="embed" type="text" class="form-control params" notnull value="" >
                            </div>

                            <div class="form-group">
                                <label for="brand">{lang('place')} (*)</label>
                                <input id="place" type="text" class="form-control params" notnull value="" >
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    ...
    function funcCancel() {
        window.location = '{base_url()}admin/manage-contact/view';
    }
