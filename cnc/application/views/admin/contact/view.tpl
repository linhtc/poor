                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered nowrap" cellspacing="0" id="data-table">
                            ...
                            <tr>
                                ...
                                <th col-id="dt">{lang('ipaddress')}</th>
                                <th col-id="m">{lang('company')}</th>
                                <th col-id="m">{lang('address')}</th>
                                <th col-id="p">{lang('phone')}</th>
                                <th col-id="p">{lang('fax')}</th>
                                <th col-id="p">{lang('email')}</th>
                                <th col-id="p">{lang('embed')}</th>
                                <th col-id="p">{lang('place')}</th>
