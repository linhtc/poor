                    ...
                    <div class="col-md-6">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input id="company" type="text" class="form-control params" notnull value="{$item->company}" >
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="fax" type="text" class="form-control params" value="{$item->fax}" >
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="embed" type="text" class="form-control params" notnull value="{$item->embed}" >
                            </div>

                            <div class="form-group">
                                <label for="brand">{lang('place')} (*)</label>
                                <input id="place" type="text" class="form-control params" notnull value="{$item->place}" >
                            </div>
                        </form>
                    </div>
                </div>
